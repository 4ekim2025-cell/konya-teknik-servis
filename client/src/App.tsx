...
function Routes() {
  ...
  useEffect(() => {
    ...
    const graph: Record<string, unknown>[] = [
      { "@context": "https://schema.org", "@type": "ProfessionalService", name: "Konya Teknik Servis", description: "Konya’da beyaz eşya ve küçük ev aletleri için WhatsApp üzerinden servis talebi ve online iş takibi sunan teknik servis.", url: window.location.href, areaServed: ["Karatay, Konya", "Meram, Konya", "Selçuklu, Konya"], serviceType: ["Beyaz eşya teknik servisi", "Küçük ev aletleri teknik servisi", "Online servis takibi"], availableLanguage: "tr" },
    ...
    if (isService) graph.push({ "@context": "https://schema.org", "@type": "Service", name: document.title, serviceType: "Beyaz eşya ve küçük ev aletleri teknik servisi", areaServed: ["Karatay", "Meram", "Selçuklu"], provider: { "@type": "ProfessionalService", name: "Konya Teknik Servis" } });
