...
import { ChevronDown, Clock3, Droplets, Fan, Flame, Gauge, House, Info, LayoutGrid, MapPin, Menu, MessageCircle, Phone, Refrigerator, Sparkles, Tags, WashingMachine, Wrench, X } from "lucide-react";
...
export function Footer() {
  return <footer className="site-footer"><div className="footer-top"><p>EŞLİ TEKNİK, Konya’da beyaz eşya ve küçük ev aletleri için aynı gün servis, orijinal parça ve online iş takibi sunar.</p><a className="footer-phone" href={contactPhoneHref}><Phone size={18} />{contactPhone}</a></div><div className="footer-links"><div><h3>Hizmetler</h3>{services.slice(0, 4).map(({ name, href }) => <a key={href} href={href}>{name}</a>)}</div><div><h3>Konya’da Servis</h3><a href="/karatay/">Karatay</a><a href="/meram/">Meram</a><a href="/selcuklu/">Selçuklu</a><a href="/tum-markalar/">Hizmet Verilen Markalar</a></div><div><h3>Bilgi Merkezi</h3><a className="footer-preform" href="/#on-bilgi-formu"><Wrench size={14} />Ön Bilgi Formu</a><a href="/online-servis-takibi/">Online İş Takibi</a><a href="/sss/">Sık Sorulan Sorular</a><a href="/hakkimizda/">Hakkımızda</a></div><div className="footer-policy-links"><h3>Yasal ve İletişim</h3><a href="/kvkk/">KVKK Aydınlatma Metni</a><a href="/gizlilik-politikasi/">Gizlilik Politikası</a><span>Çerez Politikası</span><span>İletişim</span></div><div><h3>İletişim</h3><span><Clock3 size={14} />Her gün 08:00–22:00</span><span><MapPin size={14} />Gaziosmanpaşa Mah. Menzil Cad. No:70 Karatay/KONYA</span><span><MapPin size={14} />Karatay · Meram · Selçuklu</span><a target="_blank" rel="noreferrer" href={whatsappLink}><MessageCircle size={14} />WhatsApp’tan yazın</a></div></div><div className="footer-bottom"><span>© {new Date().getFullYear()} EŞLİ TEKNİK.</span><div><a href="/kvkk/">KVKK</a></div></div></footer>;
}
