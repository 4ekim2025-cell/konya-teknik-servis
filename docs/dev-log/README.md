# Geliştirme Doğrulama Notları

Bu klasör, geliştirme sırasında yapılan görsel ve responsive kontrol kayıtlarını içerir. Dosyalar uygulamanın çalışma zamanı için gerekli değildir; geçmiş tasarım kontrollerinin kısa arşividir.
