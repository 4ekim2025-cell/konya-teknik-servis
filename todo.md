...
- [x] Ana sayfadaki koyu bilgilendirme paneli için yeni arka plan rengini uygulamak.
- [x] Referansla benzerlik taşımayan özgün hero görselini üretmek.
- [x] Hero görselini ve ilgili kontrast katmanlarını güncellemek.
- [x] Masaüstü ve mobil görünümü doğrulamak.
- [x] Güncellenen sürümü kayıt altına almak ve teslim etmek.

## Online Takip Bölümü Düzenlemesi

- [x] Masaüstü ve mobildeki mevcut takip bölümü hizasını incelemek.
